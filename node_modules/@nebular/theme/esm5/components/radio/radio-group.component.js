...
var NbRadioGroupComponent = /** @class */ (function () {
    ...
    NbRadioGroupComponent.prototype.subscribeOnRadiosBlur = function () {
        ...
        fromEvent(hostElement, 'focusin')
            .pipe(takeWhile(function () { return _this.alive; }), filter(function (event) { return hostElement.contains(event.target); }), switchMap(function () { return merge(fromEvent(_this.document, 'focusin'), fromEvent(_this.document, 'click')); }), filter(function (event) { return !hostElement.contains(event.target); }), takeUntil(this.radios.changes))
