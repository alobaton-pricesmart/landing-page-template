...
var NbDatepickerDirective = /** @class */ (function () {
    ...
    NbDatepickerDirective.prototype.setupPicker = function () {
        ...
        merge(this.picker.blur, fromEvent(this.input, 'blur').pipe(filter(function () { return !_this.picker.isShown && _this.document.activeElement !== _this.input; }))).pipe(takeWhile(function () { return _this.alive; }))
